...
class API_VOP
{
    public $APIURLBoni = 'https://api.eaponline.de/bonigateway.php?wsdl';
    public $APIURLTest = 'https://api.eaponline.de/bonigateway.php?wsdl';
    public $APIURLMahnwesen = 'https://api.eaponline.de/debitconnect.php?wsdl';
    public $shopware;
    ...
    {
        return new SoapClient($this->APIURLBoni, ['encoding' => 'UTF-8', 'cache_wsdl' => WSDL_CACHE_NONE, 'trace' => 1]);
    }

    public function test()
    {
        return new SoapClient($this->APIURLTest, ['encoding' => 'UTF-8', 'cache_wsdl' => WSDL_CACHE_NONE, 'trace' => 1]);
    }

    public function mahnwesen()
    {
        return new SoapClient($this->APIURLMahnwesen, ['encoding' => 'UTF-8', 'cache_wsdl' => WSDL_CACHE_NONE, 'trace' => 1]);
    }

    public function sendVersionInformation()
    {
        $api = $this->mahnwesen();
