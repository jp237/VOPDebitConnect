...
class FinTs
{
    ...
    public function __construct(
        ...
        $this->server = $server;
        $this->port = $port;
        $this->logger = null == $logger ? new VOPLogger($this->logger) : $logger;
    ...
    public function getStatementOfAccount(SEPAAccount $account, \DateTime $from, \DateTime $to)
    {
        ...
        $this->logger->info('RawData : '.$response->rawResponse);
        $this->logger->info('MT940 : '.print_r($responses,true));
