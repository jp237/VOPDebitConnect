<a href='VOPDebitConnect?switchTo={$smarty.get.back}' class='button'>Zurück zur Übersicht</a> <a class='button' onclick="$('.nachrichtsb').css('display','block');">Nachricht an Sachbearbeiter</a>
<div class='nachrichtsb' style='display:none;'>
<h4>Nachricht an Sachbearbeiter</h4>
<form method="post">
<input type="text" class='full' required name="nachrichtsb"><input type="submit" class='button' name="insertmsg" value='{$schuldner->sachb} Kontaktieren'>
</form>
</div>
<div class='box-group'>
<table class="full">
