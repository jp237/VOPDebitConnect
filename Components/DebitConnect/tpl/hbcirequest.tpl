...
<table width="100%"><tr><td colspan="2"><h5>Umsatzabruf HBCI</h5></td></tr><tr><td>Konto</td><td><select class='full'  name="selectedKonten">
  ...
  <tr>
    <td>Von</td>
    <td><input type="text"  name="von" value='{$smarty.post.von}' required="required" class='datepickerzahlung full' /></td>
  </tr>
  <tr>
    <td>Bis</td>
    <td><input type="text"  name="bis" value='{$smarty.post.bis}' required="required" class='datepickerzahlung full' /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><input  class='button'  type="submit" name="requesthbci" value="Umsätze abrufen" /></td>
  </tr>
  <tr>
