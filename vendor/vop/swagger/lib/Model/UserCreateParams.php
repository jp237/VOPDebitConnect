...
class UserCreateParams implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['password']) && !preg_match("/[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/", $this->container['password'])) {
     ...
     * Sets password
     *
     * @param string $password User's password. Minimum length is 6, and maximum length is 36. If not specified, then a unique random value will be generated.
     *
     * @return $this
     */
    public function setPassword($password)
    {
        ...
        if (!is_null($password) && (!preg_match("/[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/", $password))) {
            throw new \InvalidArgumentException("invalid value for $password when calling UserCreateParams., must conform to the pattern /[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/.");
        }
